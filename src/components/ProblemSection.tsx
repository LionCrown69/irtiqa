  ...
  const problems = [
    {
      ...
      desc: "Most businesses do not lose revenue dramatically. They lose it quietly when leads vanish due to unclear routing and ownership.",
    },
    {
      num: '02',
      title: 'Follow-up breaks when it matters most',
      desc: 'Warm conversations go cold because consistent follow-up systems are missing.',
    },
    {
      num: '03',
      title: 'Teams do work systems should own',
      desc: 'Scheduling, qualification, and CRM updates consume time that should be spent on revenue work.',
    },
    {
      num: '04',
      title: 'More leads into a broken machine is waste',
      desc: 'If the revenue journey is inefficient, more traffic only increases cost without fixing leakage.',
    },
    {
      num: '05',
      title: 'The founder becomes the bottleneck',
      desc: 'When one person carries sales, ops, and delivery, growth slows even when demand exists.',
    },
  ];
      ...
      <div className="problem-layout">
        <div>
          ...
          <h2 className="problem-title reveal d1">
            Most {industry ? industry.title.toLowerCase() : 'businesses'} do not lose revenue dramatically. They lose
            it <em>quietly.</em>
          </h2>
          <p className="problem-desc reveal d2 desktop-only">
            The real issue is rarely marketing. It is revenue operations infrastructure: routing, follow-up,
            qualification, booking, onboarding, and retention - disconnected, manual, or nonexistent
        ...
        <div className="reveal d2">
          <div className="cost-stack">
            <div className="calculator-panel">
              <div className="cost-title" style={{ margin: 0, color: 'var(--ink)' }}>
                Leakage Calculator
              </div>
              ...
              <div className="calculator-field">
                ...
                <select className="calculator-select" value={responseTime} onChange={(e) => setResponseTime(e.target.value)}>
