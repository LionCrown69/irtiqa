  ...
  return (
    <div className="App">
      ...
      <main className="lux-main">
        <section id="founder-hero" style={{ padding: '140px 24px 80px', position: 'relative', overflow: 'hidden' }}>
          {/* Ambient Glow */}
          <div style={{
            position: 'absolute',
            top: '30%',
          ...
          <div className="reveal" style={{ maxWidth: '800px', margin: '0 auto', position: 'relative', zIndex: 2, textAlign: 'center' }}>
            ...
            <h1 className="hero-h1" style={{ fontSize: 'clamp(44px, 7vw, 90px)', margin: '0 auto 28px', lineHeight: 1.05 }}>
              Alok Mishra
            </h1>
            
            <p className="hero-sub" style={{ fontSize: 'clamp(15px, 1.8vw, 19px)', maxWidth: '640px', lineHeight: 1.7, marginBottom: '40px' }}>
        ...
        <section id="founder-philosophy" style={{ padding: '80px 24px', borderTop: '1px solid var(--rule)', borderBottom: '1px solid var(--rule)', background: 'var(--w2)' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div className="reveal d1">
              <h2 className="problem-title" style={{ fontSize: 'clamp(28px, 4vw, 44px)', marginBottom: '32px', textAlign: 'left' }}>
                The Philosophy: <br/><em>No Fluff. No Templates.</em>
              </h2>
            </div>
            
            <div className="reveal d2" style={{ display: 'grid', gap: '28px', fontSize: '15px', lineHeight: 1.8, color: 'var(--sub)', fontWeight: 300 }}>
              <p>
