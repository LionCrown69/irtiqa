...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: 'website',
      url: `https://www.irtiqaaiagency.com/${params.locale}/use-cases/${params.industry}/${params.city}`,
    },
    twitter: {
...
export default function ProgrammaticPage({ params }: PageProps) {
  ...
  const canonicalUrl = `https://www.irtiqaaiagency.com/${params.locale}/use-cases/${params.industry}/${params.city}`;
  const title = `Revenue Operations Infrastructure for ${industry.title} in ${location.name} | Irtiqa AI`;
